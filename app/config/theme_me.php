 ...
 'views' => [
    [
        ...
        'data'     => [
            ...
            'siteTitle' => "För oss som älskar TF2",
            'siteTagline' => "Ställ frågor och få oväntade svar",
        ], 
        'sort'     => -1
    ],
    ...
    'data' => [
        ...
        // Stylesheets
        'stylesheets' => ['css/style.css', 'css/navbar_me.css', 'css/form.css', 'css/flash.css', 'css/bootstrap.min.css'],
